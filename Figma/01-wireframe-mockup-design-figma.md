...
* Will not have colors, images, or content
* We are designing the UI around the Bootstrap framework’s row and column system
...
* Change the name of the first layer to “Homepage”
* Make the grid layout:
    * *Layout Grid → Columns → change to 12*
    * *Type → Center → Width → change to 90*
    * *Gutter → change to 15*
* Create a slide banner box:
    * Change box height to 800
    * Change hex color to EEE
* Create a header box:
    * Make it 930 by 60
    * Make it go from the 0th column to end of 9th column
* Create a circle logo:
...
* Create logo text
    ...
    * Make the font 48
    * Change hex color to 999
* Group logo text and icon: select text and icon and hit Command + G
* Rename the group to “Logo”
...
* Create another box and put it over the home
    ...
    * Change hex color to 66666666
    * Change “Home” hex color to complete white
* Go to FontAwesome and download the chevron-left-solid.svg
    *  Drag and drop the chevron left into the Figma
    *  Resize it to 40 x 64
    *  Put it to the far left
    *  Reduce its color to 33% opacity
    *  Copy and paste it 180 degrees twisted on the right
* Create a dot at the bottom to represent the slides
    * Copy and paste 2 more dots spread apart by 10 pixels
    * Make the first dot hex color 666666
* Create a *Hero Title Example Text*
    * Make it bold
    * Make it 72 font
    * Align it with last column on left side
* Copy and paste Hero Title Example as “Hero Sub-Title Description”
...
* Copy and paste hero title and subtitle text to the right of the square frame
    * Allow a one column gap between the text and square frame
    * Make the margin between title and subtitle less than before
    * Make title 60 size
    * Make subtitle 36 size
...
* Add a button
    * Copy the picture frame square and place it below the description
    * Make its height 60
    * Make it three columns in length
* Add “Read More” text onto button
    * Make text white
    * Make button “666666” color
* Finishing touches
